...
export const schoolSchedule: Course[] = [
  // Monday - 使用多樣化色系
  { id: 'mon-1', name: '職涯分析與規劃', day: 1, startTime: '08:10', endTime: '10:00', location: '博愛CB105D', color: '#FCD34D' },  // 金黃色
  { id: 'mon-2', name: '國文(II)：語文表達', day: 1, startTime: '10:10', endTime: '12:00', location: '博愛C306', color: '#FB923C' },  // 橘色
  { id: 'mon-3', name: '數位電子學', day: 1, startTime: '13:10', endTime: '16:00', location: '博愛G313', color: '#A78BFA' },  // 紫色

  // Tuesday - 使用亮色系
  { id: 'tue-1', name: '網際網路概論', day: 2, startTime: '08:10', endTime: '10:00', location: '博愛G512電腦教室', color: '#60A5FA' },  // 藍色
  { id: 'tue-2', name: '大學生活學習與輔導', day: 2, startTime: '13:10', endTime: '15:00', location: '博愛G313', color: '#F9A8D4' },  // 粉紅色

  // Wednesday - 使用綠色系與紅色系
  { id: 'wed-1', name: '英文(II)', day: 3, startTime: '08:10', endTime: '10:00', location: '博愛C608', color: '#34D399' },  // 翠綠色
  { id: 'wed-2', name: '羽球', day: 3, startTime: '10:10', endTime: '12:00', location: '博愛公誠樓籃球場', color: '#F87171' },  // 紅色
  { id: 'wed-3', name: '資料結構', day: 3, startTime: '15:10', endTime: '18:00', location: '博愛G513電腦教室', color: '#818CF8' },  // 靛藍色

  // Friday - 使用多彩色系
  { id: 'fri-1', name: '民歌與吉他', day: 5, startTime: '08:10', endTime: '10:00', location: '博愛M304', color: '#2DD4BF' },  // 青色
  { id: 'fri-2', name: 'Python資料視覺化', day: 5, startTime: '10:10', endTime: '12:00', location: '博愛G521電腦教室', color: '#A3E635' },  // 萊姆綠
  { id: 'fri-3', name: 'C程式設計', day: 5, startTime: '13:10', endTime: '16:00', location: '博愛G512電腦教室', color: '#FB7185' },  // 玫瑰色
];
